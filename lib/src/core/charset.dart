...
class Charset {
  ...
  void designate(int index, int name) {
    // Match terminal behavior used by Termux/xterm-like emulators:
    // only designation "0" enables DEC special graphics; any other
    // designation switches the slot back to standard ASCII translation.
    _charsetMap[index] = _charsets[name] ?? asciiTranslator;
    _updateCache();
  }
