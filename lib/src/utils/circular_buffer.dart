...
class IndexAwareCircularBuffer<T extends IndexedItem> {
  ...
  /// Changes whenever the structure or contents of this list change.
  var _version = 0;
  ...
  /// Moves the element at [fromIndex] to [toIndex], nulling the source slot.
  /// Unlike []= (which calls _adoptChild and leaves the source dangling),
  /// this properly clears [fromIndex] so no two slots share the same object.
  void move(int fromIndex, int toIndex) => _moveChild(fromIndex, toIndex);
